...
from .Util import checkpointByPass
...
class BasicBlock(nn.Module):
    def __init__(
        ...
        hiddenFactor=2,
        hiddenFactorAttn=1,
        approxKernels=[None, None, None, None],
...
class Backbone(nn.Module):
    def __init__(
        ...
        self.posEmbedBuilder = LearnableSpatialPositionEmbedding(
            baseSize, coordDim=1, gamma=posEmbedInitGamma, dropoutProb=dropoutProb
        )
        ...
        self.upConv1dSkip = nn.ConvTranspose1d(
            baseSize * 4, baseSize * expansionFactor, 8, stride=8
        )
        ...
        self.posEmbedBuilderAttnTF = LearnableSpatialPositionEmbedding(
            baseSize * 4, coordDim=2, gamma=posEmbedInitGamma, dropoutProb=dropoutProb
        )
